                ...
                <div class="col-lg-10 col-xl-9 mx-auto">
                    <div class="card flex-row border-0 shadow rounded-3 overflow-hidden">
                        <div class="card-body p-4 p-sm-5">
                            <h3 class="card-title text-center mb-5">Connexion</h3>
                            <form method="POST" action="/login">
                                ...
                                <p class="d-block text-center mt-2 small">Vous n'avez pas de compte ? <a href="/register">En
                                        créer un</a></p>
                            </form>
                        </div>
                        <div class="card-img-left d-none d-md-flex m-3">
                            <img src="{{ asset('img/te.png') }}" alt="Login image">
                        </div>
                    </div>
                </div>
            </div>
